...
BSDATA(celli) = {
	...
	{"CellPit", NONE, decor_offset + 3 * decor_frames, FG(LookObject) | FG(Passable) | FG(MonsterForbidden)},
	...
	{"CellBloodStain", DECORS, 12 * decor_frames, FG(LookObject) | FG(Passable)},
	{"CellBloodStainBlades", DECORS, 10 * decor_frames, FG(LookObject) | FG(Passable) | FG(MonsterForbidden)},
